...
import preloader from "spectacle/es/utils/preloader";
import customStyle from '../utils/slides_themes'
...
export default class TestDiapo extends Component {
  constructor() {
    super(...arguments);
  ...
  render() {
    return (
      <div>
        <BreadcrumbsItem to={`/diapo`}>Test Diapo</BreadcrumbsItem>
        <Deck
        ...
        >
          ...
          >
            <CodePane
              lang="jsx"
              source={require('./assets/deck.example')}
              margin="20px auto"
              overflow="overflow"
            />
          </Slide>
